<template>
  ...
  <header class="flex flex-wrap items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-md shadow">
...
const estadoLabel = computed(() => {
  switch (props.consulta.estado) {
    case 'rascunho':   return 'Agendada'
    case 'iniciada':   return 'Iniciada'
    case 'concluida':  return 'Concluída'
    case 'falta':      return 'Falta'
    default:           return String(props.consulta.estado)
  }
})
